...
function changeJobPrice(type){
	switch(type){
		case 'job':
			...
			jQuery('#total_job_price').val(total.toPrecision(4));
			jQuery('#total_invoice').val(total.toPrecision(4));
			active_button();
			break;
		case 'job_resource':
			...
			jQuery('#total_resource_alloc').val(total.toPrecision(4));
			jQuery('#total_allocated').val(total.toPrecision(4));
			active_button();
			break;
	}
