...
(function($){
	$(document).ready(function(){
		...
		if(invoice_total_price == resource_total_price){
			...
			$('.alloc_msg').html('Please make sure the invoice total matches the total allocations.');
		}
...
function active_button() {
		...
		if(invoice_total_price == resource_total_price){
			...
			jQuery('.alloc_msg').html('Please make sure the invoice total matches the total allocations.');
		}
