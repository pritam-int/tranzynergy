<?php
    ...
    if($my_job_type == "my_job") {
	    ...
	    //$invoice_link .=  '<div class="add_job_link"><a href="'.base_path().'invoices" id="bulk_invoice_create">Invoices</a></div>';
		...
		<table class="views-table cols-11">
			<thead>
				<tr>
					...
					<th class="views-field views-field-title">PO/Customer Number</th>	
